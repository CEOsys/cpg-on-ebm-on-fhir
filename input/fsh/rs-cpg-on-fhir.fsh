...
* ^extension[knowledgeRepresentationLevel].valueCode = $cs-cpg-knowledgeRepresentationLevel#structured "Structured"
...
* ^extension[knowledgeCapability][+].valueCode = $cs-cpg-knowledgeCapability#computable "Computable"
* ^extension[knowledgeCapability][+].valueCode = $cs-cpg-knowledgeCapability#publishable "Publishable"
* ^extension[knowledgeCapability].valueCode = $cs-cpg-knowledgeCapability#executable "Executable"
* ^extension[knowledgeRepresentationLevel].valueCode = $cs-cpg-knowledgeRepresentationLevel#executable "Executable"
