...
<xsl:stylesheet version="1.0" xmlns:f="http://hl7.org/fhir" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="releaselabel" select="f:definition/f:parameter[f:code/f:code/@value='releaselabel']/f:value/@value"/>
    ...
    <xsl:variable name="copyrightyear" select="f:definition/f:parameter[f:code/f:code/@value='copyrightyear']/f:value/@value"/>
    ...
    <xsl:variable name="excludexml">
      <xsl:call-template name="getBoolean">
        <xsl:with-param name="boolean" select="f:definition/f:parameter[f:code/f:code/@value='excludexml']/f:value/@value"/>
        <xsl:with-param name="property" select="'excludexml'"/>
      </xsl:call-template>
    </xsl:variable>
    <xsl:variable name="excludejson">
      <xsl:call-template name="getBoolean">
        <xsl:with-param name="boolean" select="f:definition/f:parameter[f:code/f:code/@value='excludejson']/f:value/@value"/>
        <xsl:with-param name="property" select="'excludejson'"/>
      </xsl:call-template>
    </xsl:variable>
    <xsl:variable name="excludettl">
      <xsl:call-template name="getBoolean">
        <xsl:with-param name="boolean" select="f:definition/f:parameter[f:code/f:code/@value='excludettl']/f:value/@value"/>
        <xsl:with-param name="property" select="'excludettl'"/>
      </xsl:call-template>
    </xsl:variable>
    <xsl:variable name="excludelogbinaryformat">
      <xsl:call-template name="getBoolean">
        <xsl:with-param name="boolean" select="f:definition/f:parameter[f:code/f:code/@value='excludelogbinaryformat']/f:value/@value"/>
        <xsl:with-param name="property" select="'excludelogbinaryformat'"/>
      </xsl:call-template>
    </xsl:variable>
    <xsl:variable name="excludemap">
      <xsl:call-template name="getBoolean">
        <xsl:with-param name="boolean" select="f:definition/f:parameter[f:code/f:code/@value='excludemap']/f:value/@value"/>
        <xsl:with-param name="property" select="'excludemap'"/>
      </xsl:call-template>
    </xsl:variable>
    <xsl:variable name="shownav">
      <xsl:call-template name="getBoolean">
        <xsl:with-param name="boolean" select="f:definition/f:parameter[f:code/f:code/@value='shownav']/f:value/@value"/>
        <xsl:with-param name="property" select="'shownav'"/>
      </xsl:call-template>
    </xsl:variable>
    <xsl:variable name="fmm" select="f:definition/f:parameter[f:code/f:code/@value='fmm-definition']/f:value/@value"/>
