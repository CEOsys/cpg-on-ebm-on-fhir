...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  -->
  <sch:pattern>
    <sch:title>f:EvidenceVariable/f:characteristic/f:definitionByTypeAndValue/f:type</sch:title>
    <sch:rule context="f:EvidenceVariable/f:characteristic/f:definitionByTypeAndValue/f:type">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:EvidenceVariable/f:characteristic/f:definitionByCombination/f:characteristic">
      ...
      <sch:assert test="count(f:definitionCodeableConcept) &lt;= 1">definitionCodeableConcept: maximum cardinality of 'definitionCodeableConcept' is 1</sch:assert>
      <sch:assert test="count(f:definitionExpression) &lt;= 1">definitionExpression: maximum cardinality of 'definitionExpression' is 1</sch:assert>
      <sch:assert test="count(f:definitionId) &lt;= 1">definitionId: maximum cardinality of 'definitionId' is 1</sch:assert>
      <sch:assert test="count(f:definitionByTypeAndValue) &lt;= 1">definitionByTypeAndValue: maximum cardinality of 'definitionByTypeAndValue' is 1</sch:assert>
      <sch:assert test="count(f:definitionByCombination) &lt;= 1">definitionByCombination: maximum cardinality of 'definitionByCombination' is 1</sch:assert>
