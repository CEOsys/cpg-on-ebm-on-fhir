...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile CPGComputableActivityDefinition
  ...
  <sch:pattern>
    <sch:title>f:ActivityDefinition/f:dosage/f:timing</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:ActivityDefinition/f:dosage/f:timing/f:repeat</sch:title>
